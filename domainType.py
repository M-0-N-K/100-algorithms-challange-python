...
def domainType(domains):
    topLevelDomains={"com":"commercial", "org":"organization", "net":"network" ,"info":"information"}
    return [topLevelDomains[i.split(".")[-1]] for i in domains]

print(domainType(domains = ["en.wiki.org", "codefights.com", "happy.net", "code.info"]))