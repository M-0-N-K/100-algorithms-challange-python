...
candy as any other child. Determine how many pieces of candy will be eaten 
...
[output] integer The total number of pieces of candy the children will eat provided 
