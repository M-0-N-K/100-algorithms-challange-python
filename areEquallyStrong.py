...
print(areEquallyStrong(yourLeft = 15, yourRight = 10, friendsLeft = 15,friendsRight = 9))
print(areEquallyStrong(yourLeft = 15, yourRight = 10, friendsLeft = 15 , friendsRight = 10))